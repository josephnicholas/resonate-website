...
Issues are tracked as GitHub Issues in this repo (`josephnicholas/resonate-website`), via the `gh` CLI. See `docs/agents/issue-tracker.md`.

### Domain docs

Single-context layout. `CONTEXT.md` holds the domain glossary (Music Therapy vs. Individual/Group Therapy vs. Adaptive Music Lessons vs. Tempo Tunes, etc.) — use its terms consistently. `docs/adr/` holds architecture decision records. See `docs/agents/domain.md`.
